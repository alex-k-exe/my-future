...
function ProjectCard({ title, description, progress = 75 }: Omit<ProjectCardProps, 'category'> & { progress?: number }) {
  return (
    <Card className="hover:shadow-lg transition-shadow mb-4">
      <CardContent className="p-4 flex items-start gap-4">
        ...
        <div className="w-16 h-16 bg-gray-200 flex-shrink-0 relative">
          ...
          <svg className="w-full h-full opacity-50" viewBox="0 0 64 64">
            <line x1="16" y1="16" x2="48" y2="48" stroke="gray" strokeWidth="1"/>
            <line x1="16" y1="48" x2="48" y2="16" stroke="gray" strokeWidth="1"/>
          </svg>
        </div>
